...
R_VERSION=4.0.x
SVNLOC=https://svn.r-project.org/R/branches/R-4-0-branch
...
INSTALL_DIR=${CONDA_PREFIX}/R/${R_VERSION}/lib64/R
mkdir -p ${INSTALL_DIR}/site-library
cp /users/khansen/build/build_R_jhpce/Rprofile.site ${INSTALL_DIR}/etc
